...
<section class="u-align-center u-clearfix u-section-1" id="sec-121b">
  <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1" style="min-height: auto;">
	<div id="comments" class="comments-area">
		<?php if ( have_comments() ) : ?>
			<h3 class="comments-title">
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'dandd' ), get_the_title() );
				} else {
					printf(
		...
		if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
			?>
			<p class="no-comments "><?php _e( 'Comments are closed.', 'dandd' ); ?></p>
		<?php endif; ?>
