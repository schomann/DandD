...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.30.0, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'dandd' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-7cec">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70" wfd-invisible="true"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-f73c-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-f73c-20',
                    'submenu_item_class' => 'u-nav-item',
